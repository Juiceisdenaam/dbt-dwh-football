...
ENDPOINT = "players"
TABLE_NAME = "sportmonks_src_players"
CONTEXT = "players"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"

INCLUDES = ['transfers', 'trophies']  # voeg hier toe wat je wil includen
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_players (
