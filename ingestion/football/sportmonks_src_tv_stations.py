...
ENDPOINT = "tv-stations"
TABLE_NAME = "sportmonks_src_tv_stations"
CONTEXT = "tv_stations"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_tv_stations (
