...
ENDPOINT = "venues"
TABLE_NAME = "sportmonks_src_venues"
CONTEXT = "venues"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_venues (
