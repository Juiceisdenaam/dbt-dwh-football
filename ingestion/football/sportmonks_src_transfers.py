...
ENDPOINT = "transfers"
TABLE_NAME = "sportmonks_src_transfers"
CONTEXT = "transfers"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_transfers (
