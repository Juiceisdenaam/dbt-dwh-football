...
ENDPOINT = "coaches"
TABLE_NAME = "sportmonks_src_coaches"
CONTEXT = "coaches"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_coaches (
