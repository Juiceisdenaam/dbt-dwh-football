...
ENDPOINT = "markets"
TABLE_NAME = "sportmonks_src_markets"
CONTEXT = "markets"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_markets (
