...
BASE_URL = "https://api.sportmonks.com/v3/odds/"
ENDPOINT = "bookmakers"
TABLE_NAME = "sportmonks_src_bookmakers"
CONTEXT = "bookmakers"  # bijvoorbeeld "eredivisie_2024" of "premier_league_2024"

INCLUDES = []  # voeg hier toe wat je wil includen
...
CREATE TABLE IF NOT EXISTS ingestion.sportmonks_src_bookmakers (
